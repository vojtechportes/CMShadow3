(function(){
	var remove = function () {
		var $elements = $('.templateDelete[data-api-load] [data-delete-confirm]');
	...
	var update = function () {
		var parent = '.templateList[data-api-load]',
	...
	var reload = function () {
		...
		$.each($(parent), function(k, el){
			var parentData = $('.templateList' + parent).data('api-load');
	...
	$(window).on('apiReload.admin/template/list', function(){
		update();
	});	

	$(window).on('apiReloadForce.admin/template/list', function(){
		reload();
	});

	$(window).on('apiReload.admin/template/delete', function(){
		remove();
	});
})();