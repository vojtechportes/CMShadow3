...
$Database = array(
	...
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_Projects` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Name` TEXT(200) NOT NULL, `Description` TEXT(1000) NOT NULL, `ReleaseDate` TIMESTAMP DEFAULT 0, `CreatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `ModifiedAt` TIMESTAMP DEFAULT 0 ON UPDATE CURRENT_TIMESTAMP) ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"	
	),	
	array(
