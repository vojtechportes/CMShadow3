...
$Database = array(
	...
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_LayoutSlots` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Layout` INT(11) NOT NULL, `Parent` INT(11) NOT NULL DEFAULT 0, `Weight` INT(11) NOT NULL DEFAULT 50, `Name` TEXT(100) NOT NULL, `Path` TEXT(1000) NOT NULL, `Class` TEXT(1000) NULL DEFAULT '', `Identifier` TEXT(200) NULL DEFAULT '', `Data` TEXT(1000) NULL DEFAULT '') ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"
	),
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_Templates` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Name` TEXT(200) NOT NULL, `Layout` INT(11), `OutputStyle` TEXT(200) NOT NULL, `OutputType` TEXT(200) NOT NULL, `Style` TEXT(300) NOT NULL, `User` INT(11) NOT NULL, `CreatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `ModifiedAt` TIMESTAMP DEFAULT 0 ON UPDATE CURRENT_TIMESTAMP) ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"
	),
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_TemplatePages` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Name` TEXT(200) NOT NULL, `User` INT(11) NOT NULL, `CreatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `ModifiedAt` TIMESTAMP DEFAULT 0 ON UPDATE CURRENT_TIMESTAMP) ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"
	),
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_TemplatePageRefference` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Page` INT(11) NOT NULL, `Template` INT(11) NOT NULL) ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"
	)						
);
