...
$Database = array(
	...
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_Pages` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Parent` INT(11) NOT NULL, `Owner` INT(11) NOT NULL, `ChangedBy` INT(11) NOT NULL, `Version` INT(11) NOT NULL, `Locked` INT(1) NOT NULL DEFAULT 0, `Visible` INT(1) NULL DEFAULT 0, `Weight` INT(5) NULL DEFAULT 50, `CreatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `ModifiedAt` TIMESTAMP DEFAULT '') ENGINE = MyISAM CHARACTER SET utf8 COLLATE utf8_general_ci"	
	),	
	array(
		"query" => "CREATE TABLE IF NOT EXISTS `T_PageDetails` (`ID` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `Page` INT(11) NOT NULL, `Name` CHAR(200) NULL DEFAULT NULL, `Title` CHAR(200) NULL DEFAULT NULL, `Description` TEXT(600) NULL DEFAULT NULL, `Keywords` TEXT(600) NULL DEFAULT NULL, `Template` INT(11) DEFAULT 0)"
	)				
);
