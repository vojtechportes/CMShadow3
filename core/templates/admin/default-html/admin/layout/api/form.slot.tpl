	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">{_'layouts_layout_create_update_slot'}</h4>
      		</div>
      		<div class="modal-body">
				<div class="formLoader layoutSlotForm" data-api-prevent data-api-load='{"command": "loadModule", "message": false, "module": "admin/layout/api/form.slot", "arguments": <?php echo json_encode($return); ?>}'></div>
			</div>
